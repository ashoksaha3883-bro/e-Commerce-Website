      ...
      <div className="mt-6 px-4 grid grid-cols-1 md:grid-cols-2 gap-20 max-w-7xl mx-auto">
        ...
        <div className="relative h-64 sm:h-80 md:h-[420px] overflow-hidden rounded-3xl group">
          <img
            ...
            alt="Choose Us"
            className="w-full h-full object-cover rounded-3xl transform transition duration-700 group-hover:scale-110"
          />
        </div>

        {/* Text Section */}
        <div className="relative flex flex-col justify-center animate-fadeIn">
          <h2 className="font-bold text-3xl sm:text-4xl md:text-5xl mb-4 transition duration-500 hover:translate-x-2">
            Why Choose Us
          </h2>

          <p className="mt-2 mb-6 text-sm sm:text-base leading-relaxed">
          ...
          <h4 className="mt-3 text-lg sm:text-xl md:text-2xl mb-3 font-semibold transition duration-300 hover:text-blue-500">
